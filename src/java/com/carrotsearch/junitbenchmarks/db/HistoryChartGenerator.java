...
public final class HistoryChartGenerator
{
     ...
     */
    public HistoryChartGenerator(String filePrefix, String clazzName,
			LabelType labelType, DbConsumer consumer, TimeUnit timeUnit,
			String customLabel, boolean showClassName) {
    ...
    public void generate() throws Exception
    {
        ...
        // adi
        template = GeneratorUtils.replaceToken(template, "/*TIMEUNIT*/",
				getTimeUnitString(timeUnit));
        template = GeneratorUtils.replaceToken(template, "/*CUSTOMLABEL*/",
				customLabel);
