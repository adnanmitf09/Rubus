...
public class CanonicalState {
  ...
  public CanonicalState(State internal) {
  ...
  public LooseState toLoose() {
    return new LooseState(internal);
  }
  ...
  public boolean equals(Object obj) {
    ...
    return compare(internal, ((CanonicalState) obj).internal);
  }
  ...
  private boolean compare(State state1, State state2) {
    ...
    // Array Elements
      ...
      return (element1.getIndex() == element2.getIndex())
                           && compare(element1.getArray(), element2.getArray());
    // Object Fields
