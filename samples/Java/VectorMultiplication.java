...
/**
 * Simple vector multiplication test with @code{Ignore} and @code{Transform} annotations
 * @code{Ignore} will be checked first and loop will not be transformed
 */

public class VectorMultiplication {
	@Ignore
	@Transform(loops={"i"})
	private static int[] multi(int[] inputA, int[] inputB) {
